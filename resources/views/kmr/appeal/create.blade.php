    ...
    <div class="table-vert ">
        ...
        <table class=" table fixed_header " id="serch-table">
            <thead class= "fix_thead">
                <tr>
                    <th scope="col">Порядковий номер з п.року (number)</th>
                    ...
                    <th scope="col">Зміст резолюції (content_resolution_id)
                    </th>
            ...
            <tbody>
                ...
                @foreach ($appeals as $appeal)
                    <tr>
                        ...
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->number }}</a> </td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->data_reg }}</a></td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->number_reg }} </a></td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->surname_reg }}</a></td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->name_reg }}</a></td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->patronymic }}</a></td>
                        ...
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}">
                                {{ isset($appeal->question_docum) ? $appeal->question_docum->title : '' }}</a></td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->content_docum }}</a></td>
                        ...
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->destination_number }}</a>
                        </td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->destination_date }}</a>
                        </td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}">
                                {{ isset($appeal->source1_office) ? $appeal->source1_office->title : '' }}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->source1_office_txt}}</a></td> --}}
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->source1_number }}</a></td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->source1_date }}</a></td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}">
                        ...
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->source2_number }}</a></td>
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->source2_date }}</a></td>
                        ...
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->avtor_resolution }}</a>
                        </td>
                        ...
                        <td> <a href="{{ route('kmr.appeal.show', $appeal->id) }}"> {{ $appeal->data_implementation }}</a>
                        </td>
                ...
                <div>
                    <form action="{{ route('kmr.appeal.store') }}" method="post">
                        @csrf
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <div>
                                    <a href="{{ route('kmr.street.index') }}" class="btn btn-primary mb-3">Довідник
                                        адрес</a>
                            ...
                            <th>
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="type_docum" name="type_docum_id"
                                        ...
                                        @foreach ($type_docums as $item)
                                            <option {{ old('type_docum_id') == $item->id ? 'selected' : '' }}
                                ...
                                <div>
                                    <a href="{{ route('kmr.type_docum.index') }}"
                                        class="btn btn-primary mb-3">Довідник</a>
                            ...
                            <th>
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="question_docum" name="question_docum_id"
                                        ...
                                        @foreach ($question_docums as $item)
                                            <option {{ old('question_docum_id') == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}">{{ $item->title }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    <a href="{{ route('kmr.question_docum.index') }}"
                                        class="btn btn-primary mb-3">Довідник</a>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="destination_office"
                                        ...
                                        @foreach ($destination_offices as $item)
                                            <option {{ old('destination_office_id') == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}">{{ $item->title }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="source1_office" name="source1_office_id"
                                        ...
                                        @foreach ($source1_offices as $item)
                                            <option {{ old('source1_office_id') == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}">{{ $item->title }} </option>
                                        @endforeach
                                    </select>
                            ...
                            <th>
                                <div class="mb-3">
                                    <select class="form-control" aria-label="source2_office" name="source2_office_id"
                                        ...
                                        <option selected></option>
                                        @foreach ($source1_offices as $item)
                                            <option {{ old('source2_office_id') == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}">{{ $item->title }} </option>
                                        @endforeach
                                    </select>
                            ...
                            <th>
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="amount_docum" name="amount_docum_id"
                                        ...
                                        @foreach ($amount_docums as $item)
                                            <option {{ old('amount_docum_id') == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}">{{ $item->title }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    <a href="{{ route('kmr.amount_docum.index') }}"
                                        class="btn btn-primary mb-3">Довідник</a>
                            ...
                            <th>
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="content_resolution"
                                        ...
                                        @foreach ($content_resolutions as $item)
                                            <option {{ old('content_resolution_id') == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}">{{ $item->title }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    <a href="{{ route('kmr.content_resolution.index') }}"
                                        class="btn btn-primary mb-3">Довідник</a>
                                ...
                                <div class="mb-3">
                                    ...
                                    {{-- <select class="form-control" aria-label="avtor_resolution" name="avtor_resolution_id"
                                        ...
                                        @foreach ($avtor_resolutions as $item)
                                            <option {{ old('avtor_resolution_id') == $item->id ? 'selected' : '' }}
                                    ...
                                    <input type="text" name="avtor_resolution" class="form-control"
                                        id="avtor_resolution" placeholder="Директор центру ЕМДтаМК (avtor_resolution)"
                                        value="{{ 'Директор центру ЕМДтаМК' }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="executor_ophone" name="executor_ophone_id"
                                        ...
                                        @foreach ($executor_ophones as $item)
                                            <option {{ old('executor_ophone_id') == $item->id ? 'selected' : '' }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="executor_branch" name="executor_branch_id"
                                        ...
                                        @foreach ($executor_branches as $item)
                                            <option {{ old('executor_branch_id') == $item->id ? 'selected' : '' }}
                            ...
                            <th>
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" aria-label="title_implementation"
                                        ...
                                        @foreach ($title_implementations as $item)
                                            <option {{ old('title_implementation_id') == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}"> {{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    <a href="{{ route('kmr.title_implementation.index') }}"
                                        class="btn btn-primary mb-3">Довідник</a>
                                ...
                                <div class="mb-3">
                                    <select class="form-control" aria-label="validity" name="validity_id"
                                        ...
                                        @foreach ($validities as $item)
                                            <option {{ old('validity_id') == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}"> {{ $item->title }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <th>
                                ...
                                <div class="mb-3">
                                    <input type="text" name="user_id" class="form-control" id="user_id"
                                        placeholder="Хто зробив запис (user_id)" value="{{ Auth()->user()->id }}"
                                        readonly>
