...
<div>
  ...
  <tbody>
    ...
    @foreach($type_docums as $item)
        <tr>
                ...
                <th> <a href="{{route('kmr.type_docum.show', $item->id)}}"> {{$item->title}}</a> </th>
                {{-- <td> <a href="{{route('kmr.type_docum.show', $item->id)}}"> {{$item->created_at}} </a></td>
                <td> <a href="{{route('kmr.type_docum.show', $item->id)}}"> {{$item->updated_at}}</a></td>
                <td> <a href="{{route('kmr.type_docum.show', $item->id)}}"> {{$item->deleted_at}}</a></td> --}}
  ...
  @endforeach
   ...
   <div>
        <a href="{{route('kmr.type_docum.create')}}" class="btn btn-primary mb-3">Додати</a>
