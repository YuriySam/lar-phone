    ...
    <div>
        ...
        <form action="{{route('kmr.street.store')}}" method= "post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name= "user_id" class="form-control" id="user_id" placeholder="flat" value="{{Auth()->user()->id}}" readonly>
            </div>
        ...
        <a href="{{route('kmr.street.update', $street->id )}}" class="btn btn-primary mb-3">Повернутися</a>
    </div> 
</div>
