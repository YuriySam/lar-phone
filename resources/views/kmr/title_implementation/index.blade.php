...
<div>
  ...
  <tbody>
    ...
    @foreach($title_implementations as $item)
        <tr>
                ...
                <th> <a href="{{route('kmr.title_implementation.show', $item->id)}}"> {{$item->title}}</a> </th>
                {{-- <td> <a href="{{route('kmr.title_implementation.show', $item->id)}}"> {{$item->created_at}} </a></td>
                <td> <a href="{{route('admin.title_implementation.show', $item->id)}}"> {{$item->updated_at}}</a></td>
                <td> <a href="{{route('admin.title_implementation.show', $item->id)}}"> {{$item->deleted_at}}</a></td> --}}
  ...
  @endforeach
   ...
   <div>
        <a href="{{route('kmr.title_implementation.create')}}" class="btn btn-primary mb-3">Додати</a>
