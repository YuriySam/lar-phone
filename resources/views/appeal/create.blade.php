            ...
            <tbody>
                ...
                @foreach ($appeals as $appeal)
                    <tr>
                        ...
                        <td> <a href="{{ route('appeal.show', $appeal->id) }}"> {{ $appeal->street_id }}</a></td>
                        ...
                        <td> <a href="{{ route('appeal.show', $appeal->id) }}"> {{ $appeal->question_docum }}</a></td>
                ...
                <div>
                    <form action="{{ route('appeal.store') }}" method="post">
                        ...
                        @enderror
                            ...
                            <th>
                                <div class="mb-3">
                                    <select class="form-control" aria-label="validity" name="validity_id" id="validity">
                                        <option selected></option>
