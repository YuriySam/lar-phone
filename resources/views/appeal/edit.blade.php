...
@section('content')
            ...
            <tbody>
                ...
                @foreach ($appeals as $item)
                    <tr>
                        ...
                        <th> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->number }}</a> </th>
                        <th> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->data_reg }}</a></th>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->number_reg }} </a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->surname_reg }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->name_reg }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->patronymic }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->street_id }}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->street_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->phone_reg }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ isset($appeal->type_docum) ? $appeal->type_docum->title : ''}}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->type_docum_txt}}</a></td> --}}
                        {{-- {{dd($appeal->question_docum)}} --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->question_docum }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->content_docum }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->income_number }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->income_date }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->destination_office_id }}</a>
                        </td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->destination_office_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->destination_number }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->destination_date }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->source1_office_id }}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->source1_office_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->source1_number }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->source1_date }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->source2_office_id }}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->source2_office_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->source2_number }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->source2_date }}</a></td>
                        ...
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->amount_dokum_id }}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->amount_dokum_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->content_resolution_id }}</a>
                        </td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->content_resolution_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->avtor_resolution }}</a></td>
                        ...
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->executor_ophone_id }}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->executor_ophone_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->executor_branch_id }}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->executor_branch_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->data_implementation }}</a>
                        </td>
                        {{-- <td> <a href="{{ route('appeal.show', $appeal->id) }}"> {{ $appeal->namber_implementation }}</a> --}}
                        </td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $appeal->title_implementation_id }}</a>
                        </td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->title_implementation_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->validity_id }}</a></td>
                        {{-- <td> <a href="{{route('appeal.show', $appeal->id)}}"> {{$appeal->validity_txt}}</a></td> --}}
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->data_our_implementation }}</a>
                        </td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->namber_our }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->date_removal_control }}</a>
                        </td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->name_removal_control }}</a>
                        </td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->notes }}</a></td>
                        <td> <a href="{{ route('appeal.show', $item->id) }}"> {{ $item->user_id }}</a></td>
                                    ...
                                    <select class="form-control" aria-label="executor_branch" name="executor_branch_id"
                                        ...
                                        @foreach ($executor_branches as $item)
                                            <option {{ $appeal->executor_branch_id == $item->id ? 'selected' : '' }}
                                                value="{{ $item->id }}"> {{ $item->branch->branch }}</option>
                                        @endforeach
                                    </select>
    ...
    <div class="mb-3">
        ...
        <a href="{{ route('appeal.index') }}" class="btn btn-primary mb-3">Повернутися</a>
    </div>
    <div>
