...
<div>
        <a href="{{route('admin.title_implementation.edit', $title_implementation->id)}}">Edit</a>

</div>
<div>
    <form action="{{route('admin.title_implementation.destroy', $title_implementation->id)}}" method ='post'>
      @csrf
      @method('delete')
...
<div>
        <a href="{{route('admin.title_implementation.index')}}">Back</a>
