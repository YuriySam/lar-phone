...
class EditController extends BaseController
{
    public function __invoke(Appeal $appeal)
    {
        ...
        $appeals = Appeal::All();
        return view('appeal.edit',  compact('appeal', 'appeals', 'streets', 'type_docums', 'question_docums', 'destination_offices', 'source1_offices', 'source2_offices', 'amount_docums', 'content_resolutions', 'avtor_resolutions', 'executor_ophones', 'executor_branches', 'title_implementations', 'validities'));
    }
}
